...
"@media(max-width:720px){.log-out{white-space:pre-wrap;overflow-x:hidden;}}"
        ...
        H("var _gpR=0;"
          ...
          "});gl.innerHTML=h;"
          "}else if(!gd||gd.error||gd.status){"
          "gl.innerHTML='<p class=\"hint\" style=\"color:#f87171;\">SM API nicht erreichbar</p>';"
          "}else{"
          ...
          "ih+='<th style=\"padding:4px 8px;\">Mount</th><th style=\"padding:4px 8px;\"></th></tr>';"
          ...
          "ih+='<td style=\"padding:6px 8px;text-align:center;\">'+st+'</td>';"
