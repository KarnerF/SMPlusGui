...
"@media(max-width:720px){.log-out{white-space:pre-wrap;overflow-x:hidden;}}"
        ...
        H("<div class='topbar'>"
          ...
          "<button type='button' onclick='toggleSidebar()' style='background:transparent;border:1px solid var(--border);border-radius:6px;color:var(--dim);padding:4px 8px;cursor:pointer;font-size:1rem;flex-shrink:0;'>&#9776;</button>"
